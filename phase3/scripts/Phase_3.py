...
plotting_Viz_only = False  #true if do not want to use ROS
...
TestCaseCOOR = [8,5 ] # <---------------TESTER PUT INITIAL X,Y COORDINATE PT HERE
...
FinalStateCOOR = [7,7] # <---------------TESTER PUT GOAL X,Y COORDINATE PT HERE
