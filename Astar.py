...
def CheckAction(NewNode, action_cost, CTG):
    global FinalStateID
...
while ID != FinalStateID:  # will become "while explored node != G"              #pixel coors check if current node == final state                           
    ...
    #rint("length Q open list ",len(VisitedQ_eachRound))
    #print(" min ",min)
    ...
    #print("length Q open list ",len(VisitedQ_eachRound))
